...
pub enum AgentIntelligenceLevel {
    Standard,
    High,
...
impl Serialize for AgentIntelligenceLevel {
...
impl<'de> Deserialize<'de> for AgentIntelligenceLevel {
...
impl fmt::Display for AgentIntelligenceLevel {
