...
pub enum StreamTtsRequestOutputFormat {
    Pcm44100,
    Pcm24000,
    Pcm16000,
    Pcm8000,
...
impl Serialize for StreamTtsRequestOutputFormat {
...
impl<'de> Deserialize<'de> for StreamTtsRequestOutputFormat {
...
impl fmt::Display for StreamTtsRequestOutputFormat {
