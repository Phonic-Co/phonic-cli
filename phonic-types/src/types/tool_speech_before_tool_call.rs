...
pub enum ToolSpeechBeforeToolCall {
    Required,
    Optional,
    Suppressed,
...
impl Serialize for ToolSpeechBeforeToolCall {
...
impl<'de> Deserialize<'de> for ToolSpeechBeforeToolCall {
...
impl fmt::Display for ToolSpeechBeforeToolCall {
