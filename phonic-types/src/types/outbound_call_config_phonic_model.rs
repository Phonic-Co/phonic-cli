...
pub enum OutboundCallConfigPhonicModel {
    PhonicV05,
    PhonicV1,
    PhonicV11,
...
impl Serialize for OutboundCallConfigPhonicModel {
...
impl<'de> Deserialize<'de> for OutboundCallConfigPhonicModel {
...
impl fmt::Display for OutboundCallConfigPhonicModel {
