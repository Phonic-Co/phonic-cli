...
pub enum CreateAgentRequestAudioFormat {
    Pcm44100,
    Pcm24000,
    Pcm16000,
    Pcm8000,
...
impl Serialize for CreateAgentRequestAudioFormat {
...
impl<'de> Deserialize<'de> for CreateAgentRequestAudioFormat {
...
impl fmt::Display for CreateAgentRequestAudioFormat {
