...
pub enum ConversationEvalResult {
    Successful,
    Unsuccessful,
    Undecided,
    Error,
...
impl Serialize for ConversationEvalResult {
...
impl<'de> Deserialize<'de> for ConversationEvalResult {
...
impl fmt::Display for ConversationEvalResult {
