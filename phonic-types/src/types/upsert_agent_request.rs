...
pub struct UpsertAgentRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub phonic_model: Option<CreateAgentRequestPhonicModel>,
...
impl UpsertAgentRequest {
    pub fn builder() -> UpsertAgentRequestBuilder {
        <UpsertAgentRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpsertAgentRequestBuilder {
    ...
    phonic_model: Option<CreateAgentRequestPhonicModel>,
...
impl UpsertAgentRequestBuilder {
    ...
    pub fn phonic_model(mut self, value: CreateAgentRequestPhonicModel) -> Self {
    ...
    /// Consumes the builder and constructs a [`UpsertAgentRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](UpsertAgentRequestBuilder::name)
    pub fn build(self) -> Result<UpsertAgentRequest, BuildError> {
        Ok(UpsertAgentRequest {
