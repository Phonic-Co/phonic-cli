...
pub enum CreateAgentRequestMultilingualMode {
    Auto,
    Request,
    Initial,
...
impl Serialize for CreateAgentRequestMultilingualMode {
...
impl<'de> Deserialize<'de> for CreateAgentRequestMultilingualMode {
...
impl fmt::Display for CreateAgentRequestMultilingualMode {
