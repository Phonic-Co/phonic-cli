...
pub struct UpdateToolRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub on_transfer_no_answer: Option<UpdateToolRequestOnTransferNoAnswer>,
...
pub struct UpdateToolRequestBuilder {
    ...
    on_transfer_no_answer: Option<UpdateToolRequestOnTransferNoAnswer>,
...
impl UpdateToolRequestBuilder {
    ...
    pub fn on_transfer_no_answer(mut self, value: UpdateToolRequestOnTransferNoAnswer) -> Self {
