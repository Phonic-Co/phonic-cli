...
pub enum ConfigOptionsMultilingualMode {
    Auto,
    Request,
    Initial,
...
impl Serialize for ConfigOptionsMultilingualMode {
...
impl<'de> Deserialize<'de> for ConfigOptionsMultilingualMode {
...
impl fmt::Display for ConfigOptionsMultilingualMode {
