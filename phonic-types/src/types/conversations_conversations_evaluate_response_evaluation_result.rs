...
pub enum ConversationsEvaluateResponseEvaluationResult {
    Successful,
    Unsuccessful,
    Undecided,
    Error,
...
impl Serialize for ConversationsEvaluateResponseEvaluationResult {
...
impl<'de> Deserialize<'de> for ConversationsEvaluateResponseEvaluationResult {
...
impl fmt::Display for ConversationsEvaluateResponseEvaluationResult {
