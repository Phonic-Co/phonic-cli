...
pub enum ConversationMultilingualMode {
    Auto,
    Request,
    Initial,
...
impl Serialize for ConversationMultilingualMode {
...
impl<'de> Deserialize<'de> for ConversationMultilingualMode {
...
impl fmt::Display for ConversationMultilingualMode {
