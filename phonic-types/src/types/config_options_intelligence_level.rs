...
pub enum ConfigOptionsIntelligenceLevel {
    Standard,
    High,
...
impl Serialize for ConfigOptionsIntelligenceLevel {
...
impl<'de> Deserialize<'de> for ConfigOptionsIntelligenceLevel {
...
impl fmt::Display for ConfigOptionsIntelligenceLevel {
