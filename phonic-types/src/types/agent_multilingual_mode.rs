...
pub enum AgentMultilingualMode {
    Auto,
    Request,
    Initial,
...
impl Serialize for AgentMultilingualMode {
...
impl<'de> Deserialize<'de> for AgentMultilingualMode {
...
impl fmt::Display for AgentMultilingualMode {
