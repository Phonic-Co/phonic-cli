...
pub enum UpdateAgentRequestAudioFormat {
    Pcm44100,
    Pcm24000,
    Pcm16000,
    Pcm8000,
...
impl Serialize for UpdateAgentRequestAudioFormat {
...
impl<'de> Deserialize<'de> for UpdateAgentRequestAudioFormat {
...
impl fmt::Display for UpdateAgentRequestAudioFormat {
