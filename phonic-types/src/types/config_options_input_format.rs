...
pub enum ConfigOptionsInputFormat {
    Pcm44100,
    Pcm24000,
    Pcm16000,
    Pcm8000,
...
impl Serialize for ConfigOptionsInputFormat {
...
impl<'de> Deserialize<'de> for ConfigOptionsInputFormat {
...
impl fmt::Display for ConfigOptionsInputFormat {
