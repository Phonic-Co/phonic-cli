...
pub enum ConfigOptionsPhonicModel {
    PhonicV05,
    PhonicV1,
    PhonicV11,
...
impl Serialize for ConfigOptionsPhonicModel {
...
impl<'de> Deserialize<'de> for ConfigOptionsPhonicModel {
...
impl fmt::Display for ConfigOptionsPhonicModel {
