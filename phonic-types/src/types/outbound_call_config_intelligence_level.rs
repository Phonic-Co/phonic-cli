...
pub enum OutboundCallConfigIntelligenceLevel {
    Standard,
    High,
...
impl Serialize for OutboundCallConfigIntelligenceLevel {
...
impl<'de> Deserialize<'de> for OutboundCallConfigIntelligenceLevel {
...
impl fmt::Display for OutboundCallConfigIntelligenceLevel {
