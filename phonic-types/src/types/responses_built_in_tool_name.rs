...
pub enum ResponsesBuiltInToolName {
    KeypadInput,
...
impl Serialize for ResponsesBuiltInToolName {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        match self {
            ...
            Self::ChooseNotToRespond => serializer.serialize_str("choose_not_to_respond"),
            Self::__Unknown(val) => serializer.serialize_str(val),
        }
    }
}

impl<'de> Deserialize<'de> for ResponsesBuiltInToolName {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = String::deserialize(deserializer)?;
        match value.as_str() {
            "keypad_input" => Ok(Self::KeypadInput),
            "natural_conversation_ending" => Ok(Self::NaturalConversationEnding),
            "choose_not_to_respond" => Ok(Self::ChooseNotToRespond),
            _ => Ok(Self::__Unknown(value)),
        }
    }
}

impl fmt::Display for ResponsesBuiltInToolName {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Self::KeypadInput => write!(f, "keypad_input"),
            Self::NaturalConversationEnding => write!(f, "natural_conversation_ending"),
            Self::ChooseNotToRespond => write!(f, "choose_not_to_respond"),
