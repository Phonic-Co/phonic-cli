...
pub enum OutboundCallConfigBackgroundNoise {
    Office,
    CallCenter,
    CoffeeShop,
...
impl Serialize for OutboundCallConfigBackgroundNoise {
...
impl<'de> Deserialize<'de> for OutboundCallConfigBackgroundNoise {
...
impl fmt::Display for OutboundCallConfigBackgroundNoise {
