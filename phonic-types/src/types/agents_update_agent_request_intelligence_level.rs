...
pub enum UpdateAgentRequestIntelligenceLevel {
    Standard,
    High,
...
impl Serialize for UpdateAgentRequestIntelligenceLevel {
...
impl<'de> Deserialize<'de> for UpdateAgentRequestIntelligenceLevel {
...
impl fmt::Display for UpdateAgentRequestIntelligenceLevel {
