...
pub struct UpdateAgentRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub phone_number: Option<UpdateAgentRequestPhoneNumber>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub audio_format: Option<UpdateAgentRequestAudioFormat>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub background_noise: Option<UpdateAgentRequestBackgroundNoise>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub template_variables: Option<HashMap<String, UpdateAgentRequestTemplateVariablesValue>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub multilingual_mode: Option<UpdateAgentRequestMultilingualMode>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pronunciation_dictionary: Option<Vec<UpdateAgentRequestPronunciationDictionaryItem>>,
    /// Minimum number of words required to interrupt the assistant.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub min_words_to_interrupt: Option<i64>,
    /// When not `null`, at the beginning of the conversation the agent will make a POST request to this endpoint to get configuration options.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub configuration_endpoint: Option<UpdateAgentRequestConfigurationEndpoint>,
...
pub struct UpdateAgentRequestBuilder {
    name: Option<String>,
    slug: Option<String>,
    phone_number: Option<UpdateAgentRequestPhoneNumber>,
    custom_phone_number: Option<String>,
    custom_phone_numbers: Option<Vec<String>>,
    timezone: Option<String>,
    voice_id: Option<String>,
    audio_format: Option<UpdateAgentRequestAudioFormat>,
    audio_speed: Option<f64>,
    background_noise_level: Option<f64>,
    background_noise: Option<UpdateAgentRequestBackgroundNoise>,
    ...
    configuration_endpoint: Option<UpdateAgentRequestConfigurationEndpoint>,
...
impl UpdateAgentRequestBuilder {
    ...
    pub fn phone_number(mut self, value: UpdateAgentRequestPhoneNumber) -> Self {
    ...
    pub fn audio_format(mut self, value: UpdateAgentRequestAudioFormat) -> Self {
    ...
    pub fn background_noise(mut self, value: UpdateAgentRequestBackgroundNoise) -> Self {
    ...
    pub fn template_variables(mut self, value: HashMap<String, UpdateAgentRequestTemplateVariablesValue>) -> Self {
    ...
    pub fn multilingual_mode(mut self, value: UpdateAgentRequestMultilingualMode) -> Self {
    ...
    pub fn intelligence_level(mut self, value: UpdateAgentRequestIntelligenceLevel) -> Self {
    ...
    pub fn pronunciation_dictionary(mut self, value: Vec<UpdateAgentRequestPronunciationDictionaryItem>) -> Self {
    ...
    pub fn configuration_endpoint(mut self, value: UpdateAgentRequestConfigurationEndpoint) -> Self {
