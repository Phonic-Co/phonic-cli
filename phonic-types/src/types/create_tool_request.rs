...
pub struct CreateToolRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub on_transfer_no_answer: Option<CreateToolRequestOnTransferNoAnswer>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub uninterruptible: Option<bool>,
...
impl CreateToolRequest {
    pub fn builder() -> CreateToolRequestBuilder {
        <CreateToolRequestBuilder as Default>::default()
    }
}
...
pub struct CreateToolRequestBuilder {
    ...
    on_transfer_no_answer: Option<CreateToolRequestOnTransferNoAnswer>,
...
impl CreateToolRequestBuilder {
    ...
    pub fn r#type(mut self, value: CreateToolRequestType) -> Self {
        self.r#type = Some(value);
        self
    }

    pub fn execution_mode(mut self, value: CreateToolRequestExecutionMode) -> Self {
    ...
    pub fn endpoint_method(mut self, value: CreateToolRequestEndpointMethod) -> Self {
    ...
    pub fn on_transfer_no_answer(mut self, value: CreateToolRequestOnTransferNoAnswer) -> Self {
        self.on_transfer_no_answer = Some(value);
        self
    }
    ...
    pub fn uninterruptible(mut self, value: bool) -> Self {
        self.uninterruptible = Some(value);
        self
    }
    ...
    /// Consumes the builder and constructs a [`CreateToolRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](CreateToolRequestBuilder::name)
    /// - [`description`](CreateToolRequestBuilder::description)
    /// - [`r#type`](CreateToolRequestBuilder::r#type)
    /// - [`execution_mode`](CreateToolRequestBuilder::execution_mode)
    pub fn build(self) -> Result<CreateToolRequest, BuildError> {
        Ok(CreateToolRequest {
            ...
            on_transfer_no_answer: self.on_transfer_no_answer,
