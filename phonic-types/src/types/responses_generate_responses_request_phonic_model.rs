...
pub enum GenerateResponsesRequestPhonicModel {
    PhonicV05,
    PhonicV1,
    PhonicV11,
...
impl Serialize for GenerateResponsesRequestPhonicModel {
...
impl<'de> Deserialize<'de> for GenerateResponsesRequestPhonicModel {
...
impl fmt::Display for GenerateResponsesRequestPhonicModel {
