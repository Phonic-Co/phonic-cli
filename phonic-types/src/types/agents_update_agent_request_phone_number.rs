...
pub enum UpdateAgentRequestPhoneNumber {
    AssignAutomatically,
    Custom,
...
impl Serialize for UpdateAgentRequestPhoneNumber {
...
impl<'de> Deserialize<'de> for UpdateAgentRequestPhoneNumber {
...
impl fmt::Display for UpdateAgentRequestPhoneNumber {
