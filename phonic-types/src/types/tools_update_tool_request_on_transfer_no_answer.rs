...
pub enum UpdateToolRequestOnTransferNoAnswer {
    ReturnToAssistant,
    KeepRetrying,
...
impl Serialize for UpdateToolRequestOnTransferNoAnswer {
...
impl<'de> Deserialize<'de> for UpdateToolRequestOnTransferNoAnswer {
...
impl fmt::Display for UpdateToolRequestOnTransferNoAnswer {
