...
pub enum UpdateAgentRequestBackgroundNoise {
    Office,
    CallCenter,
    CoffeeShop,
...
impl Serialize for UpdateAgentRequestBackgroundNoise {
...
impl<'de> Deserialize<'de> for UpdateAgentRequestBackgroundNoise {
...
impl fmt::Display for UpdateAgentRequestBackgroundNoise {
