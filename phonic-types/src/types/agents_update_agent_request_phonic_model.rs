...
pub enum UpdateAgentRequestPhonicModel {
    PhonicV05,
    PhonicV1,
    PhonicV11,
...
impl Serialize for UpdateAgentRequestPhonicModel {
...
impl<'de> Deserialize<'de> for UpdateAgentRequestPhonicModel {
...
impl fmt::Display for UpdateAgentRequestPhonicModel {
