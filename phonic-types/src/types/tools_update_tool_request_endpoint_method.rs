...
impl Serialize for UpdateToolRequestEndpointMethod {
...
impl<'de> Deserialize<'de> for UpdateToolRequestEndpointMethod {
...
impl fmt::Display for UpdateToolRequestEndpointMethod {
