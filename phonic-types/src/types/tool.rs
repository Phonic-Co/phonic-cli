...
pub struct Tool {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub on_transfer_no_answer: Option<ToolOnTransferNoAnswer>,
...
pub struct ToolBuilder {
    ...
    on_transfer_no_answer: Option<ToolOnTransferNoAnswer>,
...
impl ToolBuilder {
    ...
    pub fn on_transfer_no_answer(mut self, value: ToolOnTransferNoAnswer) -> Self {
