...
pub enum UpdateToolRequestParameterLocationsValue {
    RequestBody,
    QueryString,
...
impl Serialize for UpdateToolRequestParameterLocationsValue {
...
impl<'de> Deserialize<'de> for UpdateToolRequestParameterLocationsValue {
...
impl fmt::Display for UpdateToolRequestParameterLocationsValue {
