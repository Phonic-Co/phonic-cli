...
pub enum UpdateToolRequestSpeechBeforeToolCall {
    Required,
    Optional,
    Suppressed,
...
impl Serialize for UpdateToolRequestSpeechBeforeToolCall {
...
impl<'de> Deserialize<'de> for UpdateToolRequestSpeechBeforeToolCall {
...
impl fmt::Display for UpdateToolRequestSpeechBeforeToolCall {
