...
pub enum UpdateAgentRequestMultilingualMode {
    Auto,
    Request,
    Initial,
...
impl Serialize for UpdateAgentRequestMultilingualMode {
...
impl<'de> Deserialize<'de> for UpdateAgentRequestMultilingualMode {
...
impl fmt::Display for UpdateAgentRequestMultilingualMode {
